...
var inptEmail = document.getElementById('inptEmail'),
     inptEmailInfo = document.getElementById('inptEmailInfo');

inptEmail.onblur = function(){

  if(inptEmail.value.match(/^[A-z0-9][A-z0-9]+@[A-z0-9]+\.+[A-z]+$/)){
    inptEmailInfo.innerHTML = '';
    return true;
}else{

  inptEmailInfo.innerHTML = '格式错误';
    inptEmailInfo.className ="cr ml100";
